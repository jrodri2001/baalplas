...
<ul class="cart_list product_list_widget <?php echo htmlspecialchars_decode($args['list_class']); ?>">
...
<?php if (sizeof(WC()->cart->get_cart()) > 0) : ?>
    ...
    <p class="buttons">
        <a href="<?php echo WC()->cart->get_cart_url(); ?>"
           class="button wc-forward"><?php _e('View Cart', 'woocommerce'); ?></a>
        <a href="<?php echo WC()->cart->get_checkout_url(); ?>"
           class="button checkout wc-forward"><?php _e('Checkout', 'woocommerce'); ?></a>
    </p>
